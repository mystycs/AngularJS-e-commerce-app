//This is the heart of our cart system, allows us to add/update/and post cart info to rails backend
'use strict';
...
.run(['$rootScope', 'ngCart', 'ngCartItem', 'store', function($rootScope, ngCart, ngCartItem, store) {
  ...
  $rootScope.$on('$viewContentLoaded', function() {
    ...
    if (authenticated) {
      ...
      if (angular.isObject(store.get(auth_token))) {
        ngCart.$restore(store.get(auth_token));
...
.service('ngCart', ['$rootScope', '$window', 'ngCartItem', 'store', function($rootScope, $window, ngCartItem, store) {
  ...
  this.$save = function() {
    ...
    if (authenticated) {
      return store.set(auth_token, JSON.stringify(this.getCart()));
    } else {
...
.factory('ngCartItem', ['$rootScope', '$log', function($rootScope, $log) {
  ...
  item.prototype.toObject = function() {
    return {
      product_id: parseInt(this.getId()),
      name: this.getName(),
      price: this.getPrice(),
